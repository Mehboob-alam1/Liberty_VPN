package com.mehboob.securanetvpn.view.fragments
...
import com.mehboob.securanetvpn.CheckInternetConnection
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding!!.serverSelectionBlock.setOnClickListener {
            if (!vpnStart) {
                ...
                mContext.toast(resources.getString(com.mehboob.securanetvpn.R.string.disconnect_first))
            }
        }
